## Hotel Get Booking Details API

This search API allows you to get booking information to generate PDFs and other things.

### Request Details

URL: `{{base_url}}/api/servicegroup/get-booking-details/hotel/`
